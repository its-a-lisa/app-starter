...
import sty from "./PlasmicPriceCard.module.css"; // plasmic-import: 95v4tkFiklHM/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ve9RG)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__p7Yg4)}>
          <div className={classNames(projectcss.all, sty.freeBox___7DFnb)}>
            {p.renderPlasmicSlot({
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__cgGm)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__o9Ly8)}>
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__vjhku)}>
              {p.renderPlasmicSlot({
                defaultContents: "8",
                value: args.dollars,
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__suAlG)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__aWajB)}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp__gZyjN)}
                  description={
                    "Vestibulum mollis odio dictum ultrices facilisis molestie vestibulum"
                  }
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg__d5Iwm)}
                      role={"img"}
                    />
                  }
                />
                ...
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp__xa60)}
                  description={"Mus consequat a justo"}
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg__rheNi)}
                      role={"img"}
                    />
                  }
                />
