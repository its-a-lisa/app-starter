...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 1mbEOw7hLjR9/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__kKeNj)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__wTq6P)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__dE1B)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__vL49I)}>
            {p.renderPlasmicSlot({
