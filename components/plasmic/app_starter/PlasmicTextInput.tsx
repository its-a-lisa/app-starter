...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: pvnp5CxIJaGY/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchIcon
              className={classNames(projectcss.all, sty.svg___6Qnim)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <CheckIcon
              className={classNames(projectcss.all, sty.svg__pZzbq)}
              role={"img"}
            />
          ),
